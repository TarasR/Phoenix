defmodule TphxWeb.ProductControllerTest do
  use TphxWeb.ConnCase

  alias Tphx.Products

  @create_attrs %{description: "some description", price: 42, slug: "some slug", title: "some title"}
  @update_attrs %{description: "some updated description", price: 43, slug: "some updated slug", title: "some updated title"}
  @invalid_attrs %{description: nil, price: nil, slug: nil, title: nil}
